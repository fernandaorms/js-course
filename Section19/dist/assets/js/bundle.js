...
/***/ "./src/class19-exercise/form-control.ts":
/*!**********************************************!*\
  !*** ./src/class19-exercise/form-control.ts ***!
  \**********************************************/
...
form.addEventListener('submit', function (event) {
    ...
    if (shouldSendForm(this)) {
        window.alert('Succes! Form submitted!');
        form.reset();
    }
    ;
});
function checkForEmptyFields(...inputs) {
    inputs.forEach((input) => {
        if (!input.value)
            showErrorMessage(input, 'Fields can\'t be empty.');
    });
}
function checkEmail(input) {
    if (!(0, isEmail_1.default)(input.value))
        showErrorMessage(input, 'Invalid e-mail');
}
function checkEqualPasswords(password, password2) {
    if (password.value !== password2.value) {
        showErrorMessage(password, 'Password don\'t match');
        showErrorMessage(password2, 'Password don\'t match');
    }
}
...
/*!***************************************!*\
  !*** ./src/class19-exercise/index.ts ***!
  \***************************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./form-control */ "./src/class19-exercise/form-control.ts");
