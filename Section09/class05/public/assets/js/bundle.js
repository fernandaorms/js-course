...
/***/ "./src/modules/FormPasswordGenerator.js":
/*!**********************************************!*\
  !*** ./src/modules/FormPasswordGenerator.js ***!
  \**********************************************/
...
/* harmony export */ });
/* harmony import */ var _PasswordGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PasswordGenerator */ "./src/modules/PasswordGenerator.js");

var size = document.querySelector('#passwordLenght');
var numbers = document.querySelector('#includeNumbers');
var symbols = document.querySelector('#includeSymbols');
var lower = document.querySelector('#includeLowercase');
var upper = document.querySelector('#includeUppercase');
var btnGenerate = document.querySelector('.button-generate > button');
var inputPassword = document.querySelector('#generatedPassword');
var btnCopy = document.querySelector('#buttonCopy');
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  btnGenerate.addEventListener('click', function () {
    var password = (0,_PasswordGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(size.value, numbers.checked, symbols.checked, lower.checked, upper.checked);
...
var generateSymbols = function generateSymbols() {
  var interval = rand(0, 4);
  switch (interval) {
    case 0:
...
function generatePassword(size, numbers, symbols, lower, upper) {
  var passwordArray = [];
  var password = '';
...
/*!*********************!*\
  ...
  \*********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_FormPasswordGenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/FormPasswordGenerator */ "./src/modules/FormPasswordGenerator.js");
/* harmony import */ var _assets_css_style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./assets/css/style.css */ "./src/assets/css/style.css");


(0,_modules_FormPasswordGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])();
})();
